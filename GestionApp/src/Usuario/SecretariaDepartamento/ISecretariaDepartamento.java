 ...
 * @author Xiomara
 */
public class ISecretariaDepartamento extends javax.swing.JFrame {

    /**
     * Creates new form ISecretariaDepartamento
     */
    public ISecretariaDepartamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Secretaria de departamento");
        ...
        jMenuItem2.setText("Generar Planilla de Nombramientos");
        ...
        jMenuItem5.setText("Validar Documentos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ISecretariaDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ISecretariaDepartamento().setVisible(true);
            }
        });
    }
