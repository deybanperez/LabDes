 ...
 * @author Xiomara
 */
public class IDirectorEscuela extends javax.swing.JFrame {

    /**
     * Creates new form IDirectorEscuela
     */
    public IDirectorEscuela() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Aprobar Nombramiento");
        ...
        jMenuItem5.setText("Notificar Resolucion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IDirectorEscuela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IDirectorEscuela().setVisible(true);
            }
        });
    }
