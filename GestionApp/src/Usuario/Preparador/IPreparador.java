 ...
 * @author Xiomara
 */
public class IPreparador extends javax.swing.JFrame {

    /**
     * Creates new form IPreparador
     */
    public IPreparador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IPreparador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IPreparador().setVisible(true);
            }
        });
    }
