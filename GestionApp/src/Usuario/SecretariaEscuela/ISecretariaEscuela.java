 ...
 * @author Xiomara
 */
public class ISecretariaEscuela extends javax.swing.JFrame {

    /**
     * Creates new form ISecretariaEscuela
     */
    public ISecretariaEscuela() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Secretaria de Escuela");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ISecretariaEscuela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ISecretariaEscuela().setVisible(true);
            }
        });
    }
